              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: (widget.isHosted)
                      ? getPalette['childpostcolour']
                      : getPalette['postcolour'],
                  border: Border(
                    top: BorderSide(width: 1.0, color: getPalette['border']),
                    left: BorderSide(width: 1.0, color: getPalette['border']),
                    right: BorderSide(width: 1.0, color: getPalette['border']),
                    bottom: BorderSide(width: 1.0, color: getPalette['border']),
                  ),
                ),
                child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Text(
                    "${postObject['age']}",
                    style: TextStyle(color: getPalette['transparent_text']),
                  ),
                  SizedBox(
                    width: 5,
                  ),
