...
print("bookmarking")
u2.add_bookmark(m12)
myuser.add_bookmark(m2)  
albert.add_bookmark(b2) 
manas.add_bookmark(s2) 
myuser.add_bookmark(t1) 
myuser.add_bookmark(b3) 
richard.add_bookmark(rwc3) 
manas.add_bookmark(rwc3)  
